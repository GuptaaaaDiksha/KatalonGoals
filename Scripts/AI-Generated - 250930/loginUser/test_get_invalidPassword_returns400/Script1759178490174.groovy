...
def userPayloadMap = [
    username: "testUser4" + uuid,
    password: "CorrectPass123" + uuid
]
...
// Step 2: Attempt login with empty password
def loginVariables = [
    username: "testUser4" + uuid,
    password: ""
]
def loginRequest = findTestObject('Swagger Petstore (1)/loginUser', loginVariables)
